...
9. On a tool error, read it and adjust; never blindly retry the same call. Before retrying or undoing anything (refreshing a CAPTCHA, re-submitting, clearing a field), verify the CURRENT page with a fresh snapshot or wait_for — the earlier step may have succeeded after your last observation.
