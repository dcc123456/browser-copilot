...
export const BLOCK_CATALOG: BlockCatalogEntry[] = [
  ...
  },
  {
    ...
    allowedInputs: true,
    maxConnection: 1,
    refDataKeys: ['selector', 'variableName', 'prefixText', 'suffixText', 'extraRowValue'],
    data: {
      disableBlock: false,
      description: '',
      findBy: 'cssSelector',
  ...
  },
  {
    ...
    allowedInputs: true,
    maxConnection: 1,
    refDataKeys: ['selector', 'variableName', 'attributeName', 'extraRowValue', 'attributeValue'],
    data: {
      disableBlock: false,
      description: '',
      findBy: 'cssSelector',
  ...
  },
  {
    ...
    allowedInputs: true,
    maxConnection: 1,
    refDataKeys: ['selector', 'variableName', 'value', 'optionPosition', 'delay'],
    data: {
      disableBlock: false,
      description: '',
      findBy: 'cssSelector',
  ...
  },
  {
    ...
    allowedInputs: true,
    maxConnection: 1,
    refDataKeys: ['customData', 'range', 'spreadsheetId', 'sheetName', 'variableName'],
    data: {
      disableBlock: false,
      range: '',
      refKey: '',
  ...
  },
  {
    ...
    allowedInputs: true,
    maxConnection: 1,
    refDataKeys: ['maxLoop', 'selector', 'variableName', 'elementSelector', 'actionElSelector'],
    data: {
      disableBlock: false,
      loopId: '',
      selector: '',
  ...
  },
  {
    ...
    allowedInputs: true,
    maxConnection: 1,
    refDataKeys: ['value', 'filename', 'saveMode', 'variableName'],
    data: {
      disableBlock: false,
      description: '',
      value: '',
