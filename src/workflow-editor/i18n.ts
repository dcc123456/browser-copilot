...
export const EDITOR_STRINGS = {
  en: {
    ...
    nodeGoal: 'Goal',
    nodeInspectorGoal: 'Goal',
    nodeInspectorSuccessCriteria: 'Success criteria',
    ...
    certificationTitle: 'Workflow certification',
    certLevelL1: 'L1 · Execution',
    certLevelL2: 'L2 · Node contracts',
    certLevelL3: 'L3 · Workflow goal',
    certNoNodeContracts: 'No node goal contracts to verify.',
  ...
  zh: {
    ...
    nodeGoal: '目标',
    nodeInspectorGoal: '目标',
    nodeInspectorSuccessCriteria: '成功条件',
    nodeInspectorPreconditions: '前置条件',
    nodeInspectorFailureMeaning: '失败含义',
    nodeInspectorRepairHints: '修复提示',
    nodeInspectorEditInvalidates: '编辑目标后，工作流将标记为未验证，直到重新认证。',
    certificationTitle: '工作流认证',
    certLevelL1: 'L1 · 执行',
    certLevelL2: 'L2 · 节点契约',
    certLevelL3: 'L3 · 工作流目标',
    certNoNodeContracts: '没有可验证的节点目标契约。',
    nodeDeleted: '算子已删除',
...
const BLOCK_FORM_STRINGS = {
  ...
  zh: {
    ...
    // — upload-file form —
    'Upload source': '上传方式',
    'User picks files': '用户选择文件',
    'Workflow file variable': '自动上传 Workflow 文件',
    'Accepted file types': '文件类型',
    'image/*,.pdf (optional)': 'image/*,.pdf（可选）',
    'File variable': '文件变量',
    'e.g. lastScreenshot': '例如 lastScreenshot',
    'Allow multiple files': '允许多文件',
    'Wait for selector before uploading': '上传前等待目标选择器',
    'Verify files reached the upload control': '验证文件已进入上传控件',
    // — get-secret form —
    Credential: '凭证',
