    ...
    drawflow: {
      ...
      nodes: [
        ...
        },
        {
          ...
          label: 'Click',
          position: { x: 1, y: 0 },
          data: { blockId: 'event-click', selector: 'a' },
        },
        {
          id: 'n3',
          label: 'Forms',
          position: { x: 2, y: 0 },
          data: { blockId: 'forms', selector: 'input' },
        },
      ],
    ...
    const wf = wfWithEdges([
      {
        ...
        source: 'n1',
        target: 'n2',
        sourceHandle: 'n1-output-1',
        targetHandle: 'n2-input-1',
      },
      {
        id: 'e2',
        source: 'n2',
        target: 'n3',
        sourceHandle: 'n2-output-1',
        targetHandle: 'n3-input-1',
      },
    ])
